...
<p class="textabstract">Vallurupalli, N., <b>Annamaneni, S.</b>, Varma, G., Jawahar, C. V., Mathew, M., & Nagori, S.(2018)<a href="assets/publications/harsha.pdf"> Efficient Semantic Segmentation using Gradual Grouping .</a> EVW @ CVPR'18 [Oral][Best paper Runner up] <span class="text-muted">PDF available.</span></p>
<p class="textabstract"> <b>Manisha, P.</b>, Jawahar, C. V., & Gujar, S.(2018)<a href="assets/publications/manisha.pdf"> Learning Optimal Redistribution Mechanisms Through Neural Networks .</a> AAMAS'18 <span class="text-muted">PDF available.</span></p>
<p class="textabstract"> <b>Reddy, S. K.</b>, Varma, G., & Jawahar, C. V.(2018)<a href="assets/publications/sudhir.pdf"> Cityscale Road Audit System using Deep Learning .</a> IROS'18 <span class="text-muted">PDF available soon.</span></p>
<p class="textabstract">Jha, A., <b> Voleti, V.</b>, Namboodiri, V. P., & Jawahar, C. V.(2018)<a href="assets/publications/vikram.pdf"> Lip-Synchronization for Dubbed Instructional Videos .</a> FIVER @ CVPR'18 <span class="text-muted">PDF available.</span></p>
<p class="textabstract"> <b>Annadani, Y.</b>, & Jawahar, C. V.(2018)<a href="assets/publications/yashas.pdf"> Augment and Adapt: A Simple Approach to Image Tampering Detection .</a> ICPR'18 <span class="text-muted">PDF available.</span></p>
<p class="textabstract"> <b>Datta, S.</b>, Sharma, G., & Jawahar, C. V. (2018)<a href="assets/publications/samyak.pdf"> Unsupervised Learning of Face Representations .</a> FG'18 <span class="text-muted">PDF available.</span></p>
<p class="textabstract"> <b>Agarwal, N.</b>, Balasubramanian, V. N., & Jawahar, C. V.(2018)<a href="assets/publications/nakul.pdf "> Improving multiclass classification by deep networks using DAGSVM and Triplet Loss .</a> Pattern Recognition Letters '18. <span class="text-muted">PDF available.</span></p>
